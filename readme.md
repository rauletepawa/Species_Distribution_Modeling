...
This comparison of the alpine vs treeline species distribution between present (2021-2040) and future (2061-2080) climatic scenarios enables us to see what are the main changes between present and future alpine species suitability acoording to the learned features of the ResNet18. As we can see, there are no obserable changes in the alpine distribution patterns in southern Norway. This might be caused due to the topography and high elevation of the terrain that really determines strong alpine conditions that shape the treeline distribution. However, if we take a look to the northen regions of the country, there are observable changes between the present and the future climate scenarios. The model suggest that in the future the treeline species will conquer the northen alpine territory. This trend is particularly evident in **Nordland and Troms counties**, where model predictions show a marked expansion of treeline species beyond their current limits. A similar pattern is observed in **Finnmark**, suggesting that warming climates will facilitate the encroachment of boreal vegetation into areas currently dominated by alpine flora.
